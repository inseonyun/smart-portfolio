...
import com.douzone.smart.portfolio.databinding.ListviewDialogDeleteUserBinding

class DialogDeleteListViewAdapter(val context: Context, var items: ArrayList<User>, private val listener: DialogDeleteUserOnItemClick) : BaseAdapter() {

    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        val binding = ListviewDialogDeleteUserBinding.inflate(LayoutInflater.from(context))
        ...
        binding.cvUser.setOnClickListener {
            ...
            AlertDialog.Builder(context).run {
                ...
                setPositiveButton("예", DialogInterface.OnClickListener { dialogInterface, _ ->
                    listener.onClick(items[p0].name, items[p0].viewType)
